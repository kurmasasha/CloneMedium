...
insert into notifications(id, text, title, is_read, user_id)
    values
        (1,'Уведомление 1','Уведомление',false, 1),
        (2,'Уведомление 2','Уведомление',false, 1),
        (3,'Уведомление 3','Уведомление',false, 1),
        (4,'Уведомление 4','Уведомление',false, 2),
        (5,'Уведомление 5','Уведомление',false, 2),
        (6,'Уведомление 6','Уведомление',false, 2),
        (7,'Уведомление 7','Уведомление',false, 3),
        (8,'Уведомление 8','Уведомление',false, 3),
        (9,'Уведомление 9','Уведомление',false, 3);
